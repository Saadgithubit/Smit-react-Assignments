...
function Addpost() {
    ...
    const addPost = async () => {
        const add = {title,amount,description,allImages,userLocation,userId}
        try {
        ...
        <div>
            ...
            <div class="form" id="form">
                <div class="inner-form">
                    ...
                    <p>Add Location</p>
                    <button className='border-2 p-2 my-2 border-r-2' onClick={() => setlocator(true)}>Add Your Current Location</button>
