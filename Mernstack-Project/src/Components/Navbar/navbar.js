...
function Navbar() {
    ...
    return (
        <div>
            <div className='flex justify-center items-center space-x-3 font-semibold absolute top-32 right-5'>
                {checked ? <p>Enable Light Mode</p>: <p>Enable Dark Mode</p>}
                <Switch 
                  onChange={(e) => setchecked(e.target.checked)}                
                />
                </div>
            <nav className="bg-white border-2 py-6 flex justify-around navbar">
